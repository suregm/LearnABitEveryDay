...
public class ThreadPoolTest {
    ...
    public static void main(String[] args) {
        ...
        int coreThreadsCount = Runtime.getRuntime().availableProcessors(); // CPU核数
        int maxThreadsCount = 2 * coreThreadsCount + 1;
        ThreadPoolExecutor pool = new ThreadPoolExecutor(coreThreadsCount, maxThreadsCount,
